<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalAdmin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddDoctor.aspx.cs" Inherits="HospitalManagement.HospitalAdmin.AddDoctor" %>
                    ...
                    <div class="basic-form">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <asp:TextBox ID="txtDrregnum" runat="server" CssClass="form-control" placeholder="Enter Registration No."></asp:TextBox>
                            </div>
                            <div class="form-group col-md-6">
