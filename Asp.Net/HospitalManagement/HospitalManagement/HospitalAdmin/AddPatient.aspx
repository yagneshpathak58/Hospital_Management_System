<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalAdmin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddPatient.aspx.cs" Inherits="HospitalManagement.HospitalAdmin.AddPatient" %>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        ...
                        <asp:Button ID="btnAddPatient" runat="server" Text="Add Patient" CssClass="btn btn-dark" OnClick="btnAddPatient_Click" />
                    </div>
                </div>
            </div>
        </div>
