<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalAdmin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="HospitalManagement.HospitalAdmin.AddUser" %>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        ...
                        <asp:Button ID="btnAddAdmin" runat="server" Text="Add Admin" CssClass="btn btn-dark" OnClick="btnAddAdmin_Click" />
                    </div>
                </div>
            </div>
        </div>
