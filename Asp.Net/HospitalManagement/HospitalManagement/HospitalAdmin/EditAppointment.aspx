<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalAdmin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="EditAppointment.aspx.cs" Inherits="HospitalManagement.HospitalAdmin.EditAppointment" %>
                    ...
                    <div class="basic-form">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <asp:TextBox ID="txtTranId" runat="server" CssClass="form-control" placeholder="Enter Transaction ID"></asp:TextBox>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Status</label>
                        ...
                        <asp:Button ID="btnUpdateAppointment" runat="server" Text="Update Appointment" CssClass="btn btn-dark" OnClick="btnUpdateAppointment_Click" />
                    </div>
                </div>
            </div>
        </div>
