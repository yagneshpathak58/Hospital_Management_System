<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalAdmin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="HospitalManagement.HospitalAdmin.EditUser" %>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <asp:DropDownList ID="ddlRole" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="super">Super-Admin</asp:ListItem>
                        ...
                        <asp:Button ID="btnEditAdmin" runat="server" Text="Save Changes" CssClass="btn btn-dark" OnClick="btnEditAdmin_Click" />
                    </div>
                </div>
            </div>
        </div>
